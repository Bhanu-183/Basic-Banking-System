...
<head>
    ...
    <title>LIST OF ALL THE TRANSACTIONS</title>
</head>
<?php
    ...
    $q="SELECT * FROM Transactions order by SNO";
    echo '<table border="0" style="margin-top:-1150px" cellspacing="2" cellpadding="15" class="table table-striped"> 
    <thead>
      <tr> 
          <th> <font face="Arial">SENDER NAME</font> </th> 
          <th> <font face="Arial">RECEIVER NAME</font> </th> 
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
        <ul class="navbar-nav" id="myDIV">
            ...
            <li class="nav-item btns">
                <a class="nav-link active" href="./transactions.php">ALL TRANSACTIONS</a>
            </li>
            <li class="nav-item btns">
